...
namespace WebAPI.Models
{
    ...
    public partial class MessageContentDTO :  IEquatable<MessageContentDTO>
    {
        ...
        /// </summary>
        /// <param name="MessageContent">MessageContent (required).</param>
        public MessageContentDTO(string MessageContent = null)
        {
            // to ensure "MessageContent" is required (not null)
            if (MessageContent == null)
            {
                throw new InvalidDataException("MessageContent is a required property for MessageContentDTO and cannot be null");
            }
            else
            {
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.MessageContent != null)
                    hash = hash * 59 + this.MessageContent.GetHashCode();
                return hash;
            }
        }
